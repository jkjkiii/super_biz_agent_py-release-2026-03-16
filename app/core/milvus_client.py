    ...
    def ensure_memory_collection(self) -> None:
        ...
        try:
            ...
            if utility.has_collection(memory_collection_name):
                logger.info(f"collection '{memory_collection_name}' 已存在")
                return

            logger.info(f"正在创建 collection '{memory_collection_name}'...")
            ...
            logger.info(f"成功创建 collection '{memory_collection_name}'")
